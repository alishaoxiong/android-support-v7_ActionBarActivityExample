...
/**
 * ActionMode是android3.0以后出现的一个用来替代ContextMenu的新菜单，主要用来响应长按等事件，
 * 不同于ContextMenu直接在中间弹出一个覆盖层，它主要出现弹出并覆盖顶部。
 * @author lsx
 *
 */
public class ActionModes extends ActionBarActivity{
...
//			MenuItemCompat.setShowAsAction(refresh2, MenuItemCompat.SHOW_AS_ACTION_IF_ROOM);
		...
		public boolean onActionItemClicked(ActionMode mode, MenuItem menu) {
			Toast.makeText(ActionModes.this, "点击:"+menu, Toast.LENGTH_LONG).show();
			return false;
		}
