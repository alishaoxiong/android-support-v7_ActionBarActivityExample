 ...
 *
 */
public class SplitActionModes extends ActionBarActivity{
	ActionMode actionMode;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_spliteactionmodes);
		((Button)findViewById(R.id.splitActionModes_btn_start)).setOnClickListener(new View.OnClickListener() {
		...
		((Button)findViewById(R.id.splitActionModes_btn_close)).setOnClickListener(new View.OnClickListener() {
	...
	private final class MyActionModels implements ActionMode.Callback{
		...
		public boolean onCreateActionMode(ActionMode mode, Menu menu) {
			...
			/*
			 * 跟ActionMode一样，它也支持xml和代码创建两种方式来创建菜单
			 */
...
//			MenuItemCompat.setShowAsAction(refresh2, MenuItemCompat.SHOW_AS_ACTION_IF_ROOM);
		...
		public boolean onActionItemClicked(ActionMode mode, MenuItem menu) {
			Toast.makeText(SplitActionModes.this, "点击:"+menu, Toast.LENGTH_LONG).show();
			return false;
		}
